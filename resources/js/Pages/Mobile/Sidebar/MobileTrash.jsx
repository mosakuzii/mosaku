...
export default function MobileTrash({ open, onClose }) {
    const { deletedMemos, setSelectedDeletedMemo, setMainMode } = useContext(AppContext);
    ...
    return (
        ...
        `}>
            <div onClick={(e) => e.stopPropagation()}
                className={`
                    fixed inset-0 z-50 h-full w-2/5 h-screen bg-gray-50 shadow-lg overflow-y-auto
            ...
            `}>
                ...
                {deletedMemos.map((memo) => (
                    <div key={memo.id}
                        ...
                        onClick={() => {setSelectedDeletedMemo(memo), onClose(), setMainMode("trash")}}>
